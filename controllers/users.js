...
// which is then stored in the browser (or sent to 
// the frontend and saved), and every subsequent request by
// the client (frontend) sends this token which is then 
